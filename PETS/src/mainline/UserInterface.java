...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	public enum TabNames {LIFECYCLES, STEPS, TASKS, CONDITIONS, EFFORTCATEGORIES, ARTIFACTS, 
	...
	private void stepsChanged() {
		...
		// This is an activate event, re-populate the comboBoxes and the Artifact items
		theStepActions.repopulate(theConditionActions, theTaskActions);
	...
	private void tasksChanged() {
		...
		// This is an activate event, re-populate the comboBoxes and the Task items
	...
	private void effortCategoriesChanged() {
		...
		// This is an activate event, re-populate the comboBoxes and the TableViews for the Effort Catregories
